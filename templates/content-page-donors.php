<div class="sponsor-page row container">
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<p class="donors-top-text">If you'd like to make a donation, click the button below: <a href="#"><button class="btn btn-default donation-btn">Make a Donation</button></a></p>	
		</div>
	</div>
